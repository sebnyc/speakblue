...
!(function (t, e) {
  ...
  const t = 'transitionend',
    ...
    l = (t) =>
      !(!o(t) || 0 === t.getClientRects().length) && 'visible' === getComputedStyle(t).getPropertyValue('visibility'),
    c = (t) =>
      !t ||
  ...
  class bi {
    ...
    _getConfig(t) {
      return (
        ((t = { ...pi, ...('object' == typeof t ? t : {}) }).rootElement = r(t.rootElement)), a('backdrop', t, mi), t
      );
    }
    _append() {
      this._isAppended ||
  ...
  class Hi extends B {
    ...
    _getConfig(t) {
      return (
        (t = { ...Ci, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), a(Ti, t, ki), t
      );
    }
    _showElement(t) {
  ...
  class Fi extends B {
    ...
    _getConfig(t) {
      return (
        (t = { ...Ri, ...U.getDataAttributes(this._element), ...('object' == typeof t ? t : {}) }), a(Bi, t, Wi), t
      );
    }
    _initializeBackDrop() {
      return new bi({
